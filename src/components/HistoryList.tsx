  ...
  if (history.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-12 px-6 text-center">
        ...
        <h3 className="text-base font-bold text-gray-800">Belum Ada Riwayat</h3>
        <p className="text-xs text-gray-500 max-w-xs mt-1 leading-relaxed">
          Mulai pindaian makanan pertama Anda dengan mengambil gambar atau memilih dari galeri!
        </p>
      </div>
    );
  }
